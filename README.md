...
$ mkdir -p out
$ ./build-release/peredur --input examples/lily02/spec.tlsf --output-dir out --seed 42
...
PEREDUR evolves a population of candidate specifications over several generations, keeping those that are realisable and close to the original.
...
The full documentation is published at [benmandrew.com/docs/peredur](https://benmandrew.com/docs/peredur/).
...
| [Architecture](https://benmandrew.com/docs/peredur/architecture.html) | algorithm flow, key types, module layout |
| [Configuration](https://benmandrew.com/docs/peredur/configuration.html) | tuning via TOML, fitness weights, selection schemes |
| [TLSF specifications](https://benmandrew.com/docs/peredur/tlsf.html) | TLSF mode and a worked repair |
| [API reference](https://benmandrew.com/docs/peredur/) | the `include/` headers |
